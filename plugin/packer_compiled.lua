...
_G.packer_plugins = {
  ...
  harpoon = {
    loaded = true,
    path = "/home/antonio/.local/share/nvim/site/pack/packer/start/harpoon",
    url = "https://github.com/ThePrimeagen/harpoon"
  },
  ["mason-lspconfig.nvim"] = {
    loaded = true,
    path = "/home/antonio/.local/share/nvim/site/pack/packer/start/mason-lspconfig.nvim",
  ...
  ["nvim-ts-context-commentstring"] = {
    loaded = true,
    path = "/home/antonio/.local/share/nvim/site/pack/packer/start/nvim-ts-context-commentstring",
    url = "https://github.com/JoosepAlviste/nvim-ts-context-commentstring"
  },
  onedark = {
    config = { "\27LJ\2\n7\0\0\3\0\3\0\0056\0\0\0009\0\1\0'\2\2\0B\0\2\1K\0\1\0\24colorscheme onedark\bcmd\bvim\0" },
    loaded = true,
    path = "/home/antonio/.local/share/nvim/site/pack/packer/start/onedark",
  ...
  ["telescope-fzf-native.nvim"] = {
    loaded = true,
    path = "/home/antonio/.local/share/nvim/site/pack/packer/start/telescope-fzf-native.nvim",
  ...
  undotree = {
    loaded = true,
    path = "/home/antonio/.local/share/nvim/site/pack/packer/start/undotree",
